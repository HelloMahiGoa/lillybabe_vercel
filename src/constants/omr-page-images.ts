/**
 * Static images for /omr-escorts — paths under public/images.
 * Hero uses shared assets; swap paths here when OMR-specific assets exist.
 */
export const OMR_PAGE_IMAGES = {
