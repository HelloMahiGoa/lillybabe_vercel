...
export function TeenEscortsPageClient() {
  return (
    <>
      <Layout>
        <main className="bg-black text-white">
          ...
          <section className="relative">
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-10 sm:pb-14">
              ...
              >
                ...
                Gallery · Teen Escorts in Chennai (18+)
              </motion.p>
              ...
              <motion.h1
                ...
                {...fadeUp(0.1)}
              >
                <span className="block text-white">Teen escorts in Chennai (18+)</span>
                <span className="block text-amber-400">younger escorts who look like their photos</span>
              </motion.h1>
              ...
              <motion.p
                ...
                {...fadeUp(0.2)}
              >
                This page gives you a sense of the teen escorts in Chennai (18+) and younger adult
                escorts we usually work with. It is not a full catalogue — more a reference for
                looks, style, and the kind of profiles you can expect when you message us.
              </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-gray-300">
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-4 sm:p-5">
                ...
                <p className="text-gray-400 leading-relaxed">
                  On this page, “teen escorts in Chennai (18+)” refers only to adults on the younger
                  side of our team — usually early twenties up to their late twenties. Everyone we
                  work with is 18 or above. If you prefer a lighter, more casual energy, this is
                  typically the right category.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-4 sm:p-5">
                ...
                <p className="text-gray-400 leading-relaxed">
                  You tell us your area, rough time, and budget. We check who fits that and is
                  realistically available, then share a few options. You can say yes, no, or ask for
                  something different — there&apos;s no pressure to confirm if it does not feel
                  right.
                </p>
              </div>
            </div>
          ...
          {/* Sample gallery — design left exactly as is */}
          <motion.section
          ...
          {/* Section 1: What kind of bookings this suits */}
          <motion.section
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-[1.15fr_1.1fr] gap-6 sm:gap-8 items-stretch">
                ...
                <div className="relative min-h-[220px] sm:min-h-[260px] lg:min-h-[280px]">
                  <div className="absolute inset-0">
                    <Image
                      src="/images/18+.avif"
                      alt="Younger escort style usually seen in Chennai bookings"
                      fill
                  ...
                  <div className="relative h-full flex flex-col justify-end px-4 sm:px-6 pb-4 sm:pb-6 text-xs sm:text-sm text-gray-200">
                    ...
                    <p className="text-[11px] sm:text-xs text-gray-200/90 max-w-sm leading-relaxed">
                      Most younger (18+) bookings look like this: a relaxed hotel or serviced
                      apartment, casual outfits, and an evening that feels more like spending time
                ...
                <div className="relative px-4 sm:px-6 py-5 sm:py-7 text-xs sm:text-sm text-gray-300 flex flex-col gap-4">
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed mb-2.5">
                      Most clients who ask for a younger escort are not fixated on age. They are
                      looking for someone who feels easy to be around — the kind of person you can
                      talk to, listen to music with, or simply share the room with after a long day
                      without any pressure.
                    </p>
                    <p className="text-gray-400 leading-relaxed">
                      If you are travelling for work, tired of being alone at a hotel, or just want
                      company that matches your own pace, this category usually works better than
                      very formal, high‑end profiles.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div className="rounded-2xl border border-white/10 bg-black/50 p-3 sm:p-4">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-gray-400 text-[11px] sm:text-xs">
                        <li>“Someone easy‑going who is fine with simple conversation and music.”</li>
                        <li>“I am in town for a night, just want relaxed company at my hotel.”</li>
                        <li>“Younger look, but still someone who knows what she is doing.”</li>
                      </ul>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-black/40 p-3 sm:p-4">
                      ...
                      <p className="text-gray-400 leading-relaxed text-[11px] sm:text-xs">
                        We frame every booking as time and company, not promises. When both of you
                        treat it that way, the evening tends to feel more natural and less like a
                        performance.
                      </p>
                    </div>
                  </div>
          ...
          {/* Section 2: How we match you with a profile */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.05)}
          >
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-[1.3fr_1.1fr]">
                ...
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-5 max-w-xl">
                    Instead of sending random profiles, we move through a simple three‑step flow so
                    the person suggested feels realistic for your time, area, and comfort level.
                  </p>
                      ...
                      <div className="relative flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 leading-relaxed">
                            ...
                            window, and the kind of energy you prefer — quiet, talkative, or
                            somewhere in the middle. A few clear lines are enough.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="relative flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 leading-relaxed">
                            ...
                            far location, we tell you honestly.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="relative flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 leading-relaxed">
                            ...
                            say yes, no, or ask for a different option. Nothing is locked in until
                            you clearly confirm one profile.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {/* Right: glass panel with time + area badges */}
          ...
          {/* Section 3: Expectations and boundaries */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.1)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.5fr_1.1fr] gap-0">
                {/* Left: main copy with highlighted lines */}
                <div className="p-5 sm:p-7 text-xs sm:text-sm text-gray-300">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-3 sm:mb-4">
                    ...
                    younger escort may be playful, open to conversation, or fine with music and a
                    drink, but she is still there in a professional setting with her own pace and
                    comfort level.
                  </p>
                  <div className="space-y-2.5">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        ...
                        feels more natural and steady.
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-400" />
                      <p className="text-gray-300 leading-relaxed">
                        If something does not feel right, saying it calmly early on is always
                ...
                {/* Right: checklist card styled differently from other sections */}
          ...
          {/* Section 4: Rough idea of pricing without hard promises */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.15)}
          >
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.3fr_1.1fr] gap-0">
                ...
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    Rates shift a bit depending on area, time of day, and how long you want to
                    spend together. Younger profiles also tend to be in higher demand on weekends
                    and holidays, so a little flexibility often helps.
                  </p>
                  <p className="text-gray-400 leading-relaxed">
                    When you message us, we share a clear amount for that specific day and slot —
                    no surprise add‑ons later. If the number does not feel right for you, you can
                    simply say so and we either adjust the plan or pause there.
                  </p>
                </div>

                {/* Right: pill-style range blocks */}
          ...
          {/* Section 5: Where younger escorts usually travel */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.2)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.3fr_1.1fr]">
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    Most younger escort bookings are in well‑connected parts of Chennai — T. Nagar,
                    Nungambakkam, Anna Nagar, OMR and nearby serviced apartments or business‑class
                    hotels. These areas make it easier for her to reach you on time without stress.
                  </p>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.4fr_1.2fr] items-center gap-4 sm:gap-6 p-5 sm:p-7">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    ...
                    area, an approximate time window, and that you are looking for a teen escort in
                    Chennai (18+) or a younger (18+) profile. We will reply with realistic options
                    and only move ahead if they feel right for you.
                  </p>
                  <p className="text-gray-400 leading-relaxed">
          ...
          {/* Section 7: A closer look at a typical evening */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.3)}
          >
              ...
              <div className="relative p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-3">
                  <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      She reaches, settles in, and you both ease into simple conversation. No rush,
                      no performance.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      Music, talk about your day, and a pace that suits both of you. The goal is for
                      it to feel natural, not scripted.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                    <p className="text-[10px] uppercase tracking-[0.16em] text-amber-300 mb-1.5">
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      Things wind down steadily instead of suddenly. The aim is for you to feel
                      like you spent time with someone you already know.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Section 8: Small signals grid with animated abstract circles */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.35)}
          >
          ...
          {/* Section 9: Good fit / not a good fit with animated side panel */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.4)}
          >
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2">
                <div className="p-5 sm:p-6 border-b md:border-b-0 md:border-r border-white/10">
                  ...
                  <ul className="space-y-1.5 text-gray-300">
                    <li className="flex items-start gap-2">
                      <span className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-400" />
                      <span>You prefer light, relaxed company over very formal setups.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-400" />
          ...
          {/* Section 10: Timeline with animated accent dots */}
          ...
          {/* Section 11: Q&A with motion tile */}
          <motion.section
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      ...
                      <p className="text-gray-400 leading-relaxed">
                        Sometimes yes, sometimes no — it depends on whether she is actually on shift
                        and free for your slot. It is safer to treat photos as a fair reference for
                        style and look rather than a guarantee for every date.
                      </p>
                    </div>
                    <div>
                      <p className="font-semibold text-white mb-1.5">
                      ...
                      <p className="text-gray-400 leading-relaxed">
                        ...
                        or special days in Chennai, it helps a lot if you reach out earlier so you
                        have more choice and less waiting.
                      </p>
                    </div>
                  </div>
                </div>
