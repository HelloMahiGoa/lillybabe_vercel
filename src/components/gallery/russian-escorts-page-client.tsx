...
export function RussianEscortsPageClient() {
  return (
    <>
      <Layout>
        <main className="bg-black text-white">
          ...
          <section className="relative">
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-10 sm:pb-14">
              ...
              >
                ...
                Gallery · Russian escorts in Chennai
              </motion.p>
              ...
              <motion.h1
                ...
                {...fadeUp(0.1)}
              >
                <span className="block text-white">Russian escorts in Chennai</span>
                <span className="block text-amber-400">European look and polished company</span>
              </motion.h1>
              ...
              <motion.p
                ...
                {...fadeUp(0.2)}
              >
                This page gives you a clear idea of the kind of Russian escorts we usually work
                with in Chennai — a different look and style from local profiles, often with
                strong English and a more international feel. Think of it as a reference for
                style and presence, not a full catalogue.
              </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-gray-300">
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-4 sm:p-5">
                <h2 className="text-sm sm:text-base font-semibold text-white mb-2">
                  What “Russian escorts in Chennai” usually means here
                </h2>
                <p className="text-gray-400 leading-relaxed">
                  We use this label for women with a European or Russian look who are based in or
                  visiting Chennai. The focus is on a different aesthetic and often stronger
                  English — easy, conversation‑friendly company, not staged behaviour or
          ...
          >
            <div className="flex items-center justify-between gap-3 mb-6 sm:mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Sample gallery — Russian escorts in Chennai
              </h2>
              <a
          ...
          {/* Section 1: When a Russian escort is usually the right choice */}
          <motion.section
                ...
                <div className="relative min-h-[220px] sm:min-h-[260px] lg:min-h-[280px]">
                  <div className="absolute inset-0">
                    <Image
                      ...
                      alt="Typical Russian escort style seen in Chennai bookings"
                      fill
                  ...
                  <div className="relative h-full flex flex-col justify-end px-4 sm:px-6 pb-4 sm:pb-6 text-xs sm:text-sm text-gray-200">
                    ...
                    <p className="text-[11px] sm:text-xs text-gray-200/90 max-w-sm leading-relaxed">
                      Many Russian escort bookings look like this: a hotel or serviced
                      apartment, polished outfits, and an evening that feels easy and unhurried.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative px-4 sm:px-6 py-5 sm:py-7 text-xs sm:text-sm text-gray-300 flex flex-col gap-4">
                  <div>
                    ...
                    <h2 className="text-lg sm:text-2xl font-bold text-white mb-3">
                      A Russian escort suits you when you want a European look and easy company
                    </h2>
                    <p className="text-gray-300 leading-relaxed mb-2.5">
                      Most clients who ask for Russian escorts in Chennai want a different look —
                      European or international — and someone who can hold a normal conversation
                      in English. They are not chasing a specific checklist; they want the room to
                      feel comfortable and the company to feel natural.
                    </p>
                    <p className="text-gray-400 leading-relaxed">
                      If you are travelling for work, hosting someone, or simply prefer a more
                      international style, this category usually fits better than strictly local
                      profiles.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div className="rounded-2xl border border-white/10 bg-black/50 p-3 sm:p-4">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-gray-400 text-[11px] sm:text-xs">
                        <li>“Someone mature who is easy to speak to.”</li>
                        <li>“Company for an evening at my hotel — Russian or international.”</li>
                        <li>“A woman who carries herself well and speaks good English.”</li>
                      </ul>
                    </div>
          ...
          {/* Section 2: How we match you with a Russian escort */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.05)}
          >
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-[1.3fr_1.1fr]">
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-5 max-w-xl">
                    ...
                    the Russian escort suggested feels realistic for your time, area, and comfort
                    level.
                  </p>
          ...
          {/* Section 3: Expectations and boundaries for Russian escorts */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.1)}
          >
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.5fr_1.1fr] gap-0">
                <div className="p-5 sm:p-7 text-xs sm:text-sm text-gray-300">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-3 sm:mb-4">
                    ...
                    Russian escort may be warm, talkative, or happy to share a drink, but she is
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.3fr_1.1fr] gap-0">
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    ...
                    together. Housewife escorts can be in higher demand at certain times, so having
          ...
          {/* Section 5: Where Russian escorts usually travel */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.2)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.3fr_1.1fr]">
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    Most Russian escort bookings are in well‑connected parts of Chennai — T.
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.4fr_1.2fr] items-center gap-4 sm:gap-6 p-5 sm:p-7">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    ...
                    area, an approximate time window, and that you are looking for a Russian
          ...
          {/* Section 7: How a Russian escort booking usually feels */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.3)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative p-5 sm:p-6">
                <h2 className="text-sm sm:text-base font-semibold text-white mb-2.5">
                  How a Russian escort booking usually feels from your side
                </h2>
          ...
          {/* Section 9: When Russian escorts are / are not a good fit */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.4)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2">
                <div className="p-5 sm:p-6 border-b md:border-b-0 md:border-r border-white/10">
                  <h2 className="text-sm sm:text-base font-semibold text-white mb-2.5">
                    When a Russian escort is likely a good fit
                  </h2>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 p-4 sm:p-6 text-xs sm:text-sm text-gray-300">
                ...
                <div className="relative grid grid-cols-1 sm:grid-cols-5 gap-3 sm:gap-4">
                  {[
                    'You send a short WhatsApp or Telegram message with area, time, and preference for a Russian escort.',
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.4fr_0.9fr] gap-4 sm:gap-6 items-stretch">
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      <p className="font-semibold text-white mb-1.5">
                        “Can I ask for a specific Russian escort again?”
                      </p>
                      <p className="text-gray-400 leading-relaxed">
                    ...
                    <div>
                      <p className="font-semibold text-white mb-1.5">
                        “How early should I contact you if I want a Russian escort?”
                      </p>
                      <p className="text-gray-400 leading-relaxed">
