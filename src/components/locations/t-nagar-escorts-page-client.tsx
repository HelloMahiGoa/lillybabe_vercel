...
export function HousewifeEscortsPageClient() {
  return (
    <>
      <Layout>
        <main className="bg-black text-white">
          ...
          <section className="relative">
            <div className="absolute inset-0">
              <Image
                ...
                alt="Housewife escorts in Chennai — LillyBabe"
                fill
                priority
                quality={85}
                sizes="100vw"
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-10 sm:pb-14">
              ...
              >
                ...
                Gallery · Housewife escorts in Chennai
              </motion.p>
              ...
              <motion.h1
                ...
                {...fadeUp(0.1)}
              >
                <span className="block text-white">Housewife escorts in Chennai</span>
                <span className="block text-amber-400">mature company that feels natural</span>
              </motion.h1>
              ...
              <motion.p
                ...
                {...fadeUp(0.2)}
              >
                This page gives you a clear idea of the kind of housewife escorts we usually work
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-gray-300">
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-4 sm:p-5">
                <h2 className="text-sm sm:text-base font-semibold text-white mb-2">
                  What “housewife escorts in Chennai” usually means here
                </h2>
                <p className="text-gray-400 leading-relaxed">
                  We use this label for women who are a bit more settled and experienced — often
                  with a calmer, grounded way of being around people. The focus is on easy,
                  conversation‑friendly company, not staged behaviour or exaggerated promises.
                </p>
              </div>
          ...
          {/* Section 1: When a housewife escort is usually the right choice */}
          <motion.section
                ...
                <div className="relative min-h-[220px] sm:min-h-[260px] lg:min-h-[280px]">
                  <div className="absolute inset-0">
                    <Image
                      ...
                      alt="Typical housewife escort style seen in Chennai bookings"
                      fill
                  ...
                  <div className="relative h-full flex flex-col justify-end px-4 sm:px-6 pb-4 sm:pb-6 text-xs sm:text-sm text-gray-200">
                    ...
                    <p className="text-[11px] sm:text-xs text-gray-200/90 max-w-sm leading-relaxed">
                      Many housewife escort bookings look like this: a calm hotel or serviced
                      apartment, simple outfits, and an evening that feels steady and unhurried.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative px-4 sm:px-6 py-5 sm:py-7 text-xs sm:text-sm text-gray-300 flex flex-col gap-4">
                  <div>
                    ...
                    <h2 className="text-lg sm:text-2xl font-bold text-white mb-3">
                      A housewife escort suits you when you want unhurried, easy company
                    </h2>
                    <p className="text-gray-300 leading-relaxed mb-2.5">
                      Most clients who ask for housewife escorts in Chennai are not chasing a
                      specific “type”. They simply want someone who is at ease with herself, can
                      hold a normal conversation, and makes the room feel comfortable instead of
                      tense.
                    </p>
                    <p className="text-gray-400 leading-relaxed">
                      If you are coming off a long week, travelling for work, or just want company
                      that feels grounded and normal, this category usually works better than very
                      flashy or high‑drama profiles.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div className="rounded-2xl border border-white/10 bg-black/50 p-3 sm:p-4">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-gray-400 text-[11px] sm:text-xs">
                        ...
                        <li>“Company for a quiet evening at my hotel.”</li>
                        <li>“A woman who feels real, not staged.”</li>
                      </ul>
                    </div>
          ...
          {/* Section 2: How we match you with a housewife escort */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.05)}
          >
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-[1.3fr_1.1fr]">
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-5 max-w-xl">
                    ...
                    the housewife escort suggested feels realistic for your time, area, and comfort
                    level.
                  </p>
          ...
          {/* Section 3: Expectations and boundaries for housewife escorts */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.1)}
          >
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.5fr_1.1fr] gap-0">
                <div className="p-5 sm:p-7 text-xs sm:text-sm text-gray-300">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-3 sm:mb-4">
                    ...
                    housewife escort may be warm, talkative, or happy to share a drink, but she is
          ...
          {/* Section 5: Where housewife escorts usually travel */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.2)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.3fr_1.1fr]">
                <div className="p-5 sm:p-7">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    Most housewife escort bookings are in well‑connected parts of Chennai — T.
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.4fr_1.2fr] items-center gap-4 sm:gap-6 p-5 sm:p-7">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-3">
                    ...
                    area, an approximate time window, and that you are looking for a housewife
          ...
          {/* Section 7: How a housewife escort booking usually feels */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.3)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative p-5 sm:p-6">
                <h2 className="text-sm sm:text-base font-semibold text-white mb-2.5">
                  How a housewife escort booking usually feels from your side
                </h2>
          ...
          {/* Section 9: When housewife escorts are / are not a good fit */}
          <motion.section
            className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12"
            {...fadeUp(0.4)}
          >
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/95 text-xs sm:text-sm text-gray-300">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2">
                <div className="p-5 sm:p-6 border-b md:border-b-0 md:border-r border-white/10">
                  <h2 className="text-sm sm:text-base font-semibold text-white mb-2.5">
                    When a housewife escort is likely a good fit
                  </h2>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-[1.4fr_0.9fr] gap-4 sm:gap-6 items-stretch">
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      <p className="font-semibold text-white mb-1.5">
                        “Can I ask for a specific housewife escort again?”
                      </p>
                      <p className="text-gray-400 leading-relaxed">
                    ...
                    <div>
                      <p className="font-semibold text-white mb-1.5">
                        “How early should I contact you if I want someone mature?”
                      </p>
                      <p className="text-gray-400 leading-relaxed">
