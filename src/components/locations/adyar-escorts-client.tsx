...
export function AdyarEscortsClient() {
  ...
  const WA_URL = 'https://wa.me/918121426651?text=Hi%2C%20I%20want%20to%20book%20verified%20escorts%20in%20Adyar%20Chennai.%20Please%20share%20available%20profiles.';
  const TRUST_BADGES = [
        ...
        <nav className="bg-zinc-950/80 border-b border-white/8 py-3 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-white/30">/</span>
              <span className="text-amber-400 font-semibold">Adyar Escorts</span>
            </div>
          </div>
        </nav>
        ...
        <section className="relative">
          <div className="absolute inset-0 -top-20">
            <Image
              ...
              alt="Adyar Escorts — LillyBabe Chennai"
              fill
              priority
              quality={85}
              sizes="100vw"
              ...
              <div className="grid lg:grid-cols-[1fr_380px] gap-10 lg:gap-16 items-center">
                <div>
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 rounded-full px-4 py-1.5 mb-6 sm:mb-8">
                    ...
                    <span className="text-amber-400 text-[11px] font-bold uppercase tracking-[0.18em]">Escorts in Adyar · Verified and Discreet</span>
                  </motion.div>
                  <motion.h1 className="font-black leading-[0.88] tracking-tight mb-5 sm:mb-6" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
                    <span className="block text-white text-[clamp(2.75rem,10vw,6.5rem)]">Adyar Escorts</span>
                  ...
                  <motion.div className="flex items-center gap-3 mb-5 sm:mb-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.25 }}>
                    ...
                    <p className="text-gray-300 text-sm sm:text-base font-medium"><strong className="text-white">Verified Adyar escorts</strong>, discreet WhatsApp coordination, and no-advance clarity.</p>
                  </motion.div>
                  <motion.p className="text-gray-400 text-sm sm:text-base leading-relaxed max-w-lg mb-7 sm:mb-8" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.35 }}>
                    Book premium escorts in Adyar Chennai with verified profiles, private WhatsApp confirmation, and clear no-advance policy.
                  </motion.p>
                ...
                <motion.div className="hidden lg:flex flex-col gap-4" initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
                  ...
                  <div className="relative h-64 rounded-2xl overflow-hidden border border-white/10">
                    <Image src="/images/verified-girls.png" alt="Adyar Chennai profile highlights" fill className="object-cover" sizes="380px" />
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-gray-600 leading-relaxed">
                        Feeling super energetic? Let's go shopping and explore everything! Want to just chill and relax? We'll find a cozy cafÃ© and hang out. Our Adyar call girls are really good at reading your mood and matching your energy. They'll make sure your day goes exactly how you want it - whether that's action-packed or totally laid back!
                      </p>
                    </div>
                  </div>
                </motion.div>
