...
import { AdyarDocSectionsLine9 } from '@/components/locations/adyar-doc-sections-line9';
...
import { ADYAR_PAGE_IMAGES } from '@/constants/adyar-page-images';
import { ADYAR_ESCORTS_FAQ } from '@/constants/adyar-faq';
import {
...
const BOOKING_STEPS: { title: string; detail: string }[] = [
  {
    ...
    detail:
      'Say you are looking in Adyar or Besant Nagar, your rough timing, and whether you prefer a hotel meet or another arrangement. We reply with what fits.',
  },
  {
    title: 'Match & confirm',
    detail:
...
const ADYAR_LAST_UPDATED_ISO = getHomepageLastUpdatedIso();
const ADYAR_LAST_UPDATED_LABEL = getHomepageLastUpdatedLabel();

export function AdyarEscortsClient() {
  const [openFAQ, setOpenFAQ] = useState<number | null>(null);

  useEffect(() => {
    trackPageView('/adyar-escorts', 'Adyar Escorts | Verified Girls in Chennai');
  ...
  const WA_URL =
    'https://wa.me/918121426651?text=Hi%2C%20I%20want%20to%20book%20verified%20escorts%20in%20Adyar%20Chennai.%20Please%20share%20available%20profiles.';
  const TRUST_BADGES = [
  ...
  const introCards = [
    {
      ...
      body: (
        <>
          Looking for <strong className={KW.strongPink}>Adyar escorts</strong> with clear,{' '}
    ...
    {
      icon: Heart,
      title: 'Companionship that fits Adyar',
      body: (
        <>
          Our <strong className={KW.strongPink}>escort girls in Adyar</strong> enjoy matching your mood — from café plans
  ...
  const experienceBlocks = [
    {
      ...
      copy: (
        <>
          ...
          Adyar, Besant Nagar, and the south Chennai waterfront belt.
        </>
      ),
    ...
    },
    {
      ...
      copy: (
        <>
          ...
          <strong className={KW.strongLight}>Adyar</strong>, the Besant belt, and connected south Chennai corridors.
        </>
      ),
  ...
  const faqItems = [...ADYAR_ESCORTS_FAQ];
    ...
    <div className="min-h-screen bg-black">
      ...
      <nav className="border-b border-dashed border-amber-500/25 bg-[linear-gradient(90deg,rgba(24,24,27,0.97)_0%,rgba(9,9,11,0.98)_50%,rgba(24,24,27,0.97)_100%)] py-3 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center gap-2 px-4 text-sm sm:px-6 lg:px-8">
          ...
          <span className="text-white/30">/</span>
          <span className="font-semibold text-amber-400">Adyar escorts</span>
        </div>
      </nav>
      ...
      <section className="relative pb-0">
        <div className="absolute inset-0 -top-20">
          <Image
            src={ADYAR_PAGE_IMAGES.heroBg}
            alt="Adyar escorts Chennai — LillyBabe verified escort service"
            fill
            priority
            quality={85}
            sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_360px] lg:gap-16">
              <div>
                ...
                >
                  <span className="block text-[clamp(2.5rem,9vw,5.5rem)] text-white">Adyar</span>
                ...
                >
                  ...
                  booking. Whether you want <strong className={KW.strong}>affordable call girls in Adyar</strong> or a
                  premium evening near Besant Nagar and the coast, we help you shortlist fast.
                </motion.p>
                <motion.div
                ...
                >
                  ...
                  <time dateTime={ADYAR_LAST_UPDATED_ISO} className="text-xs font-medium text-white sm:text-sm">
                    {ADYAR_LAST_UPDATED_LABEL}
                  </time>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-2xl border border-rose-500/20">
                  <Image
                    src={ADYAR_PAGE_IMAGES.heroAside}
                    alt="Adyar escorts — Chennai companion service"
                    width={420}
                    height={280}
      ...
      <TodaysProfilesSection
        ...
        eyebrowText="Tonight in Adyar"
        headingText="Fresh Adyar Escorts You Can Book Now"
        descriptionText="These are the latest active profiles for Adyar escorts in Chennai, curated for faster shortlisting and direct WhatsApp confirmation."
      />
                ...
                <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-10">
                  <div className="border-2 border-black bg-[#ebe6dc] px-6 py-8 sm:px-8 sm:py-10">
                    <p className="font-serif text-[1.0625rem] leading-[1.82] text-[#1c1917] sm:text-lg">
                      ...
                      <strong className={KW.printInk}>Adyar escorts</strong> with only 10k per shot? If Yes, then no
                  ...
                  <figure>
                    <div className="border-2 border-black bg-[#1c1917] p-1">
                      <Image
                        src={ADYAR_PAGE_IMAGES.docLine1}
                        alt="Chennai escorts Adyar LillyBabe"
                        width={640}
                        height={420}
              ...
              <div className="p-5 sm:p-8">
                ...
                <div className="grid items-stretch gap-8 lg:grid-cols-2 lg:gap-10">
                  <div className="relative aspect-[4/3] w-full border-2 border-black bg-[#292524] lg:order-1">
                    <Image
                      src={ADYAR_PAGE_IMAGES.docLine3}
                      alt="Chennai independent call girls Adyar"
                      fill
                  ...
                  <div className="relative border-2 border-black bg-[#f3f0e8] p-7 sm:p-9 lg:order-2">
                    ...
                    <p className="pl-4 font-serif text-[1.0625rem] leading-[1.82] text-[#1c1917] sm:text-lg">
                      ...
                      book Low rate call girls in <strong className={KW.printInk}>Adyar</strong>.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch lg:gap-10">
                  <div className="flex flex-col justify-center border-2 border-black bg-[#2a151c] px-6 py-8 sm:px-9 sm:py-10">
                    <p className="font-serif text-[1.0625rem] leading-[1.82] text-[#f0e4e8] sm:text-lg">
                      And our <strong className={KW.printPlum}>escort girls in Adyar</strong> are willing to play with you
                  ...
                  <div className="relative min-h-[220px] border-2 border-black bg-black lg:min-h-[300px]">
                    <Image
                      src={ADYAR_PAGE_IMAGES.docLine5}
                      alt="Adyar escorts Chennai call girls"
                      fill
                      className="object-cover"
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-black text-zinc-900 sm:text-4xl">
              Gallery — <span className="text-rose-600">Adyar mood</span>
            </h2>
      ...
      <AdyarDocSectionsLine9 />
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mx-auto mt-3 max-w-2xl text-sm text-zinc-400 sm:text-base">
                ...
                then publish — so your time in <strong className="text-zinc-200">Adyar</strong> is not wasted on fake ads.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative w-full max-w-md rotate-[-2deg] rounded-sm bg-white p-3 pb-12 shadow-2xl ring-1 ring-black/20 transition-transform duration-500 hover:rotate-0">
                <div className="overflow-hidden bg-black">
                  <Image
                    src={ADYAR_PAGE_IMAGES.polaroid}
                    alt="Chennai escorts Adyar — discreet bookings"
                    width={640}
                    height={480}
                    className="aspect-[4/3] w-full object-cover"
                  />
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <ul className="mt-6 space-y-3 text-sm text-zinc-300">
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    Familiar with <strong className="text-white">Adyar</strong>, LB Road, and evening south Chennai traffic
                    windows.
                  </span>
                </li>
                <li className="flex gap-2">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-white sm:text-4xl">
                Planning a booking in <span className="text-amber-400">Adyar</span>
              </h2>
              ...
              >
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-zinc-400">
                    Adyar sits south of the core city — leafy avenues, LB Road, and quick hops toward Besant Nagar and the
                    coast. Mention your hotel or landmark when you message — we factor traffic and guest policy into timing.
                  </p>
        ...
        <section className="bg-gradient-to-b from-zinc-950 to-black py-16">
          <div className="mx-auto max-w-3xl px-4">
            <h2 className="mb-8 text-center font-serif text-3xl font-black italic text-white">FAQ — Adyar escorts</h2>
