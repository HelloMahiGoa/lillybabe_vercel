...
import { EgmoreDocSectionsLine9 } from '@/components/locations/egmore-doc-sections-line9';
...
import { EGMORE_PAGE_IMAGES } from '@/constants/egmore-page-images';
...
/** Same as homepage hero: “today” in Asia/Kolkata (ISO + label). */
const EGMORE_LAST_UPDATED_ISO = getHomepageLastUpdatedIso();
const EGMORE_LAST_UPDATED_LABEL = getHomepageLastUpdatedLabel();

const BOOKING_STEPS: { title: string; detail: string }[] = [
  {
    title: 'Message on WhatsApp',
    detail:
      'Say you are looking in Egmore, your rough timing, and whether you prefer a hotel meet or another arrangement. We reply with what fits.',
  },
  {
    title: 'Match & confirm',
    detail:
...
export function EgmoreEscortsClient() {
  ...
  useEffect(() => {
    trackPageView('/egmore-escorts', 'Egmore Escorts | Chennai');
  ...
  const WA_URL =
    'https://wa.me/918121426651?text=Hi%2C%20I%20want%20to%20book%20verified%20escorts%20in%20Egmore%20Chennai.%20Please%20share%20available%20profiles.';
  ...
  const introCards = [
    {
      ...
      body: (
        <>
          Looking for <strong className={KW.strongPink}>Egmore escorts</strong> with clear,{' '}
          <strong className={KW.strongPink}>honest rates</strong>? LillyBabe is a real platform where{' '}
          <strong className={KW.strongPink}>local independent call girls</strong> and agency-style listings come
          together — <strong className={KW.strongPink}>no middleman commission</strong> games on our side; coordination
          stays direct on WhatsApp.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <strong className={KW.strongPink}>verification comes first</strong>, then the profile goes live. That is how
          we keep <strong className={KW.strongPink}>Chennai escorts</strong> listings safer and more reliable for you.
        </>
      ),
    },
    {
      icon: Heart,
      title: 'Companionship that fits Egmore',
      body: (
        <>
          Our <strong className={KW.strongPink}>escort girls in Egmore</strong> enjoy matching your mood — from café
          plans and hotel evenings to relaxed downtime. We focus on <strong className={KW.strongPink}>consensual</strong>,{' '}
  ...
  const experienceBlocks = [
    {
      ...
      copy: (
        <>
          Need a polished partner for a <strong className={KW.strongLight}>corporate dinner</strong>, birthday, or
          private celebration? Our <strong className={KW.strongLight}>VIP Chennai escorts</strong> are chosen for
          presence, conversation, and ease in upscale venues — including{' '}
          <strong className={KW.strongLight}>5-star hotels</strong> near Egmore and the city centre.
        </>
      ),
    ...
    },
    {
      ...
      copy: (
        <>
          No two clients are alike. Share your idea — quiet night in, city drive, or late check-in — and we align you
          with someone who fits. <strong className={KW.strongLight}>Romantic dates</strong>,{' '}
    ...
    {
      tag: 'Always on',
      title: '24/7 Egmore & Chennai',
      copy: (
        <>
          Spontaneous plan or odd-hour arrival? <strong className={KW.strongLight}>Chennai escorts</strong> on our
          roster are reachable round the clock. Message when you land — we respond fast for{' '}
          <strong className={KW.strongLight}>Egmore</strong>, Nungambakkam, and connected corridors.
        </>
      ),
  ...
  const faqItems = [...EGMORE_ESCORTS_FAQ];
    ...
    <div className="min-h-screen bg-black">
      ...
      <nav className="border-b border-dashed border-amber-500/25 bg-[linear-gradient(90deg,rgba(24,24,27,0.97)_0%,rgba(9,9,11,0.98)_50%,rgba(24,24,27,0.97)_100%)] py-3 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center gap-2 px-4 text-sm sm:px-6 lg:px-8">
          ...
          <span className="text-white/30">/</span>
          <span className="font-semibold text-amber-400">Egmore escorts</span>
        </div>
      </nav>
      ...
      <section className="relative pb-0">
        <div className="absolute inset-0 -top-20">
          <Image
            src={EGMORE_PAGE_IMAGES.heroBg}
            alt="Egmore escorts Chennai — LillyBabe verified escort service"
            fill
            priority
            quality={85}
            sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_360px] lg:gap-16">
              <div>
                ...
                >
                  <span className="block text-[clamp(2.5rem,9vw,5.5rem)] text-white">Egmore</span>
                ...
                >
                  ...
                  booking. Whether you want <strong className={KW.strong}>affordable call girls in Egmore</strong> or a
                  premium evening, we help you shortlist fast.
                </motion.p>
                <motion.div
                ...
                >
                  ...
                  <time
                    dateTime={EGMORE_LAST_UPDATED_ISO}
                    className="text-xs font-medium text-white sm:text-sm"
                  >
                    {EGMORE_LAST_UPDATED_LABEL}
                  </time>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-2xl border border-rose-500/20">
                  <Image
                    src={EGMORE_PAGE_IMAGES.heroAside}
                    alt="Egmore escorts — Chennai companion service"
                    width={420}
                    height={280}
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-2 text-xs text-white/90">
                    <span className="inline-flex items-center gap-1.5">
                      <Train className="h-3.5 w-3.5 text-amber-300" />
                      Near Egmore station & hotels
                    </span>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="mt-8 grid grid-cols-4 gap-2 lg:hidden">
              {STATS.map((s) => (
                <div key={s.label} className="rounded-xl border border-white/10 bg-black/40 py-3 text-center backdrop-blur-sm">
      ...
      <TodaysProfilesSection areaLabel="Egmore" sectionId="todays-profiles" />

      {/* egmore-escorts.md lines 1, 3, 5 (+ line 7) — print insert: flat ink + paper (no glow orbs / pills / timeline) */}
          ...
          <div className="space-y-10 sm:space-y-12">
            ...
            >
              <div className="border-b-2 border-black bg-black px-3 py-2 sm:px-4">
                <span className="font-mono text-[10px] uppercase tracking-[0.28em] text-white sm:text-[11px]">I — Egmore</span>
              </div>
                ...
                <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-10">
                  <div className="border-2 border-black bg-[#ebe6dc] px-6 py-8 sm:px-8 sm:py-10">
                    <p className="font-serif text-[1.0625rem] leading-[1.82] text-[#1c1917] sm:text-lg">
                      ...
                      <strong className={KW.printInk}>Egmore escorts</strong> with only 10k per shot? If Yes, then no
                  ...
                  <figure>
                    <div className="border-2 border-black bg-[#1c1917] p-1">
                      <Image
                        src={EGMORE_PAGE_IMAGES.docLine1}
                        alt="Chennai escorts Egmore LillyBabe"
                        width={640}
                        height={420}
              ...
              <div className="p-5 sm:p-8">
                ...
                <div className="grid items-stretch gap-8 lg:grid-cols-2 lg:gap-10">
                  <div className="relative aspect-[4/3] w-full border-2 border-black bg-[#292524] lg:order-1">
                    <Image
                      src={EGMORE_PAGE_IMAGES.docLine3}
                      alt="Chennai independent call girls Egmore"
                      fill
                  ...
                  <div className="relative border-2 border-black bg-[#f3f0e8] p-7 sm:p-9 lg:order-2">
                    ...
                    <p className="pl-4 font-serif text-[1.0625rem] leading-[1.82] text-[#1c1917] sm:text-lg">
                      ...
                      book Low rate call girls in <strong className={KW.printInk}>Egmore</strong>.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch lg:gap-10">
                  <div className="flex flex-col justify-center border-2 border-black bg-[#2a151c] px-6 py-8 sm:px-9 sm:py-10">
                    <p className="font-serif text-[1.0625rem] leading-[1.82] text-[#f0e4e8] sm:text-lg">
                      And our <strong className={KW.printPlum}>escort girls in Egmore</strong> are willing to play with you
                  ...
                  <div className="relative min-h-[220px] border-2 border-black bg-black lg:min-h-[300px]">
                    <Image
                      src={EGMORE_PAGE_IMAGES.docLine5}
                      alt="Egmore escorts Chennai call girls"
                      fill
                      className="object-cover"
      ...
      {/* Gallery — diagonal split backdrop */}
      <section
        id="egmore-gallery"
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-black text-zinc-900 sm:text-4xl">
              Gallery — <span className="text-rose-600">Egmore mood</span>
            </h2>
      ...
      {/* docs/egmore-escorts.md line 9 onward — verbatim sections, unique layouts */}
      <EgmoreDocSectionsLine9 />
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm text-zinc-400 sm:text-base">
              ...
              then publish — so your time in <strong className="text-zinc-200">Egmore</strong> is not wasted on fake ads.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative w-full max-w-md rotate-[-2deg] rounded-sm bg-white p-3 pb-12 shadow-2xl ring-1 ring-black/20 transition-transform duration-500 hover:rotate-0">
              <div className="overflow-hidden bg-black">
                <Image
                  src={EGMORE_PAGE_IMAGES.polaroid}
                  alt="Chennai escorts Egmore — discreet bookings"
                  width={640}
                  height={480}
                  className="aspect-[4/3] w-full object-cover"
                />
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <ul className="mt-6 space-y-3 text-sm text-zinc-300">
              ...
              <li className="flex gap-2">
                ...
                <span>
                  Familiar with <strong className="text-white">Egmore</strong>, Park Town, and central Chennai traffic
                  windows.
                </span>
              </li>
              <li className="flex gap-2">
      ...
      {/* Guide: booking flow, locality, rates, safety, boundaries + last updated */}
      <section
        id="egmore-booking-guide"
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-white sm:text-4xl">
              Planning a booking in <span className="text-amber-400">Egmore</span>
            </h2>
            ...
            >
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
                ...
                <p className="mt-4 text-sm leading-relaxed text-zinc-400">
                  Egmore sits on the city&apos;s main rail spine and is a short hop from business hotels, Park Town, and
                  corridors toward Nungambakkam and the Marina. Mention your hotel or landmark when you
                  message — we factor traffic and guest policy into timing.
                </p>
      ...
      <section className="bg-gradient-to-b from-zinc-950 to-black py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="mb-8 text-center font-serif text-3xl font-black italic text-white">FAQ — Egmore escorts</h2>
