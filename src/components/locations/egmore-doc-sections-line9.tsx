...
export function EgmoreDocSectionsLine9() {
  return (
    <>
      {/* docs/egmore-escorts.md line 9 — ink + folio split */}
        ...
        <div className="mx-auto grid max-w-6xl items-stretch gap-6 px-4 lg:grid-cols-12 lg:gap-0 lg:px-8">
          ...
          >
            <p className="font-serif text-[1.05rem] leading-[1.85] text-stone-300 sm:text-lg">
              Escorts In <strong className="font-semibold text-stone-100">Egmore</strong> We brings offer model independent
