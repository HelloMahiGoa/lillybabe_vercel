        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>Basic companionship, dinner dates, and social events typically range from Rs 8,000-15,000 per hour. This includes conversation, social interaction, and basic companionship without intimate services.</p>

              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Intimate Services</h3>
              <p>Intimate services typically range from Rs 12,000-25,000 per hour, depending on the specific services and the escort's experience level. Rates vary based on what's included and the escort's comfort level.</p>

              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Specialized Services</h3>
              <p>Specialized services like roleplay, fetish services, or unique experiences typically range from Rs 15,000-30,000 per hour. These services require more preparation and expertise, hence the higher rates.</p>
