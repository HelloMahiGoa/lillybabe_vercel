...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://lillybabe.com/teen-escorts',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://lillybabe.com/teen-escorts',
  },
  other: {
    'theme-color': '#ec4899',
...
export default function TeenEscortsPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://lillybabe.com/teen-escorts"
      }
    ]
  };
  ...
  return (
    <>
      ...
      {/* SEO Monitoring */}
      <SEOMonitoring pageType="category" pageUrl="https://lillybabe.com/teen-escorts" pageTitle="Teen Escorts in Chennai | Young & Beautiful Escorts | Lillybabe" />
