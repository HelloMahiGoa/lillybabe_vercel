...
const PAGE_URL = 'https://lillybabe.com/omr-escorts';
const OG_IMAGE_PATH = '/images/omr-1.avif';

const PAGE_TITLE =
  'OMR Escorts Chennai | Verified Girls, No Advance | LillyBabe';

const PAGE_DESCRIPTION =
  "Book verified OMR escorts along Chennai's IT corridor with LillyBabe: direct WhatsApp coordination, hotel-friendly options where policy allows, and pay after you meet — no advance on our standard flow.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    'OMR escorts',
    'escorts in OMR Chennai',
    'OMR call girls',
    'Chennai escorts OMR',
    'IT corridor escorts Chennai',
    'verified escorts OMR',
  ...
  const structuredDataGraph = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        mainEntity: OMR_ESCORTS_FAQ.map((item) => ({
          '@type': 'Question',
          name: item.q,
          acceptedAnswer: {
            '@type': 'Answer',
