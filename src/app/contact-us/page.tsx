...
export const metadata: Metadata = {
  ...
  description:
    'One number, two apps. Message us on WhatsApp or Telegram for Chennai escort bookings, availability, and simple questions. We reply as soon as we can.',
  keywords: [
    'contact Chennai escorts',
    'LillyBabe contact',
    'Chennai escort booking WhatsApp',
    'Chennai escort Telegram',
  ],
  openGraph: {
    title: 'Contact LillyBabe — Chennai Escort Bookings & Questions',
    description:
  ...
  twitter: {
    ...
    description:
      'WhatsApp and Telegram contact details for LillyBabe Chennai escort bookings.',
...
const TG_URL = 'https://t.me/Tamil_Escorts';
          ...
          <section className="relative">
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-10 sm:pb-14">
              ...
              <h1 className="font-black leading-[0.92] tracking-tight mb-5 text-[clamp(2.4rem,7vw,3.6rem)]">
                ...
                <span className="block text-amber-400">two simple ways to reach us</span>
              </h1>
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed max-w-xl mb-6">
                ...
                costs, or how the booking works, just send a short message on WhatsApp or Telegram.
              </p>
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 pt-4 sm:pt-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-8 sm:mb-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 sm:gap-4 rounded-2xl bg-[#229ED9]/10 border border-[#229ED9]/40 hover:bg-[#229ED9]/20 hover:border-[#229ED9]/60 transition-all duration-200 px-4 py-4 sm:px-5 sm:py-5"
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mt-1">
                    Good if you prefer to keep everything inside Telegram.
                  </p>
                </div>
              </a>
            </div>
