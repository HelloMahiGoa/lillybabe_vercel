...
const PAGE_URL = 'https://lillybabe.com/ecr-escorts';
const OG_IMAGE_PATH = '/images/ecr-1.avif';

const PAGE_TITLE =
  'ECR Escorts Chennai | Verified Girls, No Advance | LillyBabe';

const PAGE_DESCRIPTION =
  "Book verified ECR escorts along Chennai's East Coast Road with LillyBabe: direct WhatsApp coordination, hotel-friendly options where policy allows, and pay after you meet — no advance on our standard flow.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    'ECR escorts',
    'escorts in ECR Chennai',
    'East Coast Road escorts',
    'ECR call girls',
    'Chennai escorts ECR',
    'beach road escorts Chennai',
    'verified escorts ECR',
    'no advance escorts Chennai',
    'LillyBabe ECR',
    'pay after meet escorts Chennai',
    'WhatsApp escort booking Chennai',
    'Thiruvanmiyur escorts',
    'Besant Nagar escorts ECR',
    'resort escorts Chennai',
  ],
  ...
  const structuredDataGraph = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        mainEntity: ECR_ESCORTS_FAQ.map((item) => ({
          '@type': 'Question',
          name: item.q,
          acceptedAnswer: {
            '@type': 'Answer',
