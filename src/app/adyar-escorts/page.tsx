...
const PAGE_URL = 'https://lillybabe.com/adyar-escorts';
const OG_IMAGE_PATH = '/images/adyar-1.avif';

const PAGE_TITLE =
  'Adyar Escorts Chennai | Verified Girls, No Advance | LillyBabe';

const PAGE_DESCRIPTION =
  "Book verified Adyar escorts in south Chennai with LillyBabe: direct WhatsApp coordination, hotel-friendly options where policy allows, and pay after you meet — no advance on our standard flow.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    'Adyar escorts',
    'escorts in Adyar Chennai',
    'Adyar call girls',
    'Chennai escorts Adyar',
    'Besant Nagar escorts',
    'LB Road escorts',
    'verified escorts Adyar',
    'no advance escorts Chennai',
    'LillyBabe Adyar',
    'pay after meet escorts Chennai',
    'WhatsApp escort booking Chennai',
    'south Chennai escorts',
    'Thiruvanmiyur escorts near Adyar',
  ],
  ...
  const structuredDataGraph = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        mainEntity: ADYAR_ESCORTS_FAQ.map((item) => ({
          '@type': 'Question',
          name: item.q,
          acceptedAnswer: {
            '@type': 'Answer',
