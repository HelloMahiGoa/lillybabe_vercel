          ...
          <div className="relative bg-white/80 backdrop-blur-sm shadow-xl border-b border-white/20">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4 lg:space-x-6">
                  <motion.button
                  onClick={() => window.history.back()}
                    className="flex items-center text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-105 bg-white/50 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg hover:shadow-xl"
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <motion.div 
                      className="relative w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-2xl"
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      transition={{ type: "spring", stiffness: 300 }}
                    >
                      <Heart className="w-6 h-6 lg:w-8 lg:h-8 text-white fill-current" />
                      <div className="absolute inset-0 bg-gradient-to-br from-pink-400 to-purple-600 rounded-2xl blur opacity-75"></div>
                    </motion.div>
                    
                  <div>
                      <motion.h1 
                        className="text-xl lg:text-3xl font-black text-gray-900 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text"
                      ...
                      <div className="flex items-center space-x-3 lg:space-x-6 text-sm lg:text-base text-gray-600 mt-2">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  onClick={() => setIsBookmarked(!isBookmarked)}
                    className="p-3 text-gray-400 hover:text-red-500 transition-all duration-300 rounded-full hover:bg-red-50/80 backdrop-blur-sm shadow-lg hover:shadow-xl"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                  >
                    <Heart className={`w-6 h-6 ${isBookmarked ? 'fill-current text-red-500' : ''}`} />
                  </motion.button>
                  ...
                  onClick={() => navigator.share ? navigator.share({title: `${profile.name} - Premium Escort Profile`, url: window.location.href}) : navigator.clipboard.writeText(window.location.href)}
                    className="p-3 text-gray-400 hover:text-blue-500 transition-all duration-300 rounded-full hover:bg-blue-50/80 backdrop-blur-sm shadow-lg hover:shadow-xl"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                  >
                  ...
                  <motion.div 
                    className="hidden sm:flex items-center space-x-2 bg-gradient-to-r from-green-100 to-emerald-100 px-4 py-2 rounded-full shadow-lg"
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    ⏰ <strong>Contact hours: 10 AM - 11 PM only</strong>
                  </p>
                  </motion.div>
                ...
                <div className="p-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-b-3xl">
                  <div className="flex gap-4">
                    ...
                    <motion.button
                      ...
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl hover:from-green-600 hover:to-emerald-700 transition-all duration-300 font-bold shadow-lg hover:shadow-xl"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Send via WhatsApp
